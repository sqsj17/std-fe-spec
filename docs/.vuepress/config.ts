  ...
  themeConfig: {
    nav: [
      ...
      },
      {
        text: 'NPM包',
        items: [
          { text: 'std-eslint-config', link: '/npm/eslint.md' },
          { text: 'std-stylelint-config', link: '/npm/stylelint.md' },
          { text: 'std-commitlint-config', link: '/npm/commitlint.md' },
          { text: 'std-markdownlint-config', link: '/npm/markdownlint.md' },
          { text: 'std-eslint-plugin', link: '/npm/eslint-plugin.md' },
        ],
      },
      {
        text: '脚手架',
    ...
    sidebar: [
      ...
      },
      {
        title: 'NPM包',
        children: [
          { title: 'std-eslint-config', path: '/npm/eslint.md' },
          { title: 'std-stylelint-config', path: '/npm/stylelint.md' },
          { title: 'std-commitlint-config', path: '/npm/commitlint.md' },
          { title: 'std-markdownlint-config', path: '/npm/markdownlint.md' },
          { title: 'std-eslint-plugin', path: '/npm/eslint-plugin.md' },
        ],
      },
      {
        title: '脚手架',
    ...
    footer: {
      createYear: 2023,
      copyrightInfo:
        '<a href="https://github.com/sqsj17/std-fe-spec" target="_blank">github</a>',
    },
