...
- 安装各种依赖：包括 `Linter` 依赖，如 [ESLint](https://eslint.org/)、[stylelint](https://stylelint.io/)、[commitlint](https://commitlint.js.org/#/)、[markdownlint](https://github.com/DavidAnson/markdownlint) 等；配置依赖，如 [std-eslint-config](https://www.npmjs.com/package/std-eslint-config)、[std-stylelint-config](https://www.npmjs.com/package/std-stylelint-config)、[std-commitlint-config](https://www.npmjs.com/package/std-commitlint-config)、[std-markdownlint-config](https://www.npmjs.com/package/std-markdownlint-config) 等
- 写入各种配置文件，包括：
