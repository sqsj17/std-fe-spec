...
describe('Validate JS configs', () => {
  ...
  it('Validate std-eslint-config/es5', async () => {
  ...
  it('Validate std-eslint-config/vue', async () => {
  ...
  it('Validate std-eslint-config/essential', async () => {
  ...
  it('Validate std-eslint-config/essential/es5', async () => {
  ...
  it('Validate std-eslint-config/essential/react', async () => {
  ...
  it('Validate std-eslint-config/essential/vue', async () => {
  ...
  it('Validate std-eslint-config/node', async () => {
