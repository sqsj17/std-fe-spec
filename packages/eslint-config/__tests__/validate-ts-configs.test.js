...
describe('Validate TS configs', () => {
  it('Validate std-eslint-config/typescript', async () => {
  ...
  it('Validate std-eslint-config/typescript/vue', async () => {
  ...
  it('Validate std-eslint-config/essential/typescript', async () => {
  ...
  it('Validate std-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate std-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate std-eslint-config/typescript/node', async () => {
